...
- [ ] Create isolated component `frontend/src/components/plot/BatchRecordsTable.tsx` with props: `rows`, `varieties`, `onToggleSelectAll`, `onToggleRowSelect`, `onUpdateField`, `onFocusPlot`, `onSubmit`, `loading`, `disabled`.
...
- [ ] Connect map focus button with smooth camera transition.
