...
export function BatchSummaryCard({
  ...
  return (
    <div
      className={`rounded-[3px] bg-white border border-black/[0.08] p-[13px] space-y-[13px] ${className}`}
    >
      {/* Top Task Row: File Metadata & Quick Actions */}
      <div className="flex items-center justify-between gap-[13px]">
        <div className="flex items-center gap-[10px] min-w-0">
          <div className="w-[34px] h-[34px] rounded-[3px] bg-[#ecfdf5] text-[#059669] flex items-center justify-center flex-shrink-0">
          ...
          <div className="min-w-0">
            ...
            <div className="flex items-center gap-1.5 mt-0.5 text-[11px] text-[#71717a]">
              <span className="inline-flex items-center rounded-[3px] bg-[#ecfdf5] border border-[#a7f3d0] px-[6px] py-[1px] text-[10px] font-medium text-[#059669]">
                {summary.format}
              </span>
              <span>•</span>
        ...
        <button
          type="button"
          onClick={onReset}
          className="hover:bg-[var(--hover)] text-[#71717a] hover:text-rose-600 rounded-[3px] p-1.5 transition-colors flex-shrink-0"
          title="Ganti berkas"
        >
          <X className="w-4 h-4" />
        </button>
      ...
      <div className="grid grid-cols-3 gap-[8px]">
        <div className="bg-white border border-black/[0.08] rounded-[3px] p-[10px] text-center">
      ...
      <div className="bg-white border border-black/[0.08] rounded-[3px] p-[13px] space-y-[10px]">
        <div className="flex items-center justify-between gap-2">
          ...
          <button
            type="button"
            onClick={onApplyBulk}
            className="rounded-[3px] h-[30px] px-[13px] bg-[var(--accent)] hover:bg-[#047857] text-white text-[12px] font-medium transition-colors flex items-center gap-1.5 cursor-pointer"
          >
        ...
        <div className="grid grid-cols-3 gap-[8px]">
          <div>
            ...
            <select
              ...
              className="w-full h-[34px] px-[10px] text-[13px] rounded-[3px] border border-black/[0.08] bg-white focus:border-[var(--accent)] text-[#09090b] outline-none transition-colors"
            >
